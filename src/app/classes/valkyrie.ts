...
export const VALKYRIE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'endurance', name: 'Endurance', icon: '❤️', iconImg: 'img/talents/valkyrie/endurance.jpg', description: 'Aumenta tu stamina un 3% y tu probabilidad de crítico un 2% por punto.', maxRank: 3, tier: 1, requires: null },
    ...
    { id: 'improved_fly_the_nest', name: 'Improved Fly the Nest', icon: '🕊️', iconImg: 'img/abilities/valkyrie/fly_the_nest.jpg', description: 'Fly the Nest te da energía de lanza y escudo: R1 = tu nivel, R2 = 2×nivel y R3 = 3×nivel de cada una.', maxRank: 3, tier: 2, requires: null },
    ...
    { id: 'hurtfull_lightning', name: 'Hurtfull lightning', icon: '⚡', iconImg: 'img/talents/valkyrie/hurtfull_lightning.jpg', description: 'Aumenta tu daño crítico un 5% y tu probabilidad de crítico un 2% por punto.', maxRank: 3, tier: 3, requires: null },
    { id: 'lightning_vortex', name: 'Lightning Vortex', icon: '🌀', iconImg: 'img/talents/valkyrie/lightning_vortex.jpg', description: 'Aumenta el daño de Javelin of Lightning un 10% por punto. Con al menos 1 punto, también otorga un +10% fijo a la contribución de energía de Plunge, Impale y Slam.', maxRank: 2, tier: 3, requires: null },
  ...
  capstones: [
    ...
    { id: 'call_from_valhalla', name: 'Call from Valhalla', icon: '⚔️', iconImg: 'img/capstones/valkyrie/call_from_valhalla.jpg', description: 'Desbloquea Call from Valhalla: devuelve a la vida a un aliado muerto en combate con toda su vida y le otorga +50 Attack Power y +50 Spell Power durante 2 turnos. CD 10.' },
    { id: 'last_will', name: 'Last Will', icon: '📯', iconImg: 'img/capstones/valkyrie/valkyries_call.jpg', description: 'Desbloquea Last Will: durante 3 turnos tus habilidades gastan vida en vez de ira (10 de ira → 5% de vida maxima) y tienes +50 Attack Power. CD 10.' },
  ],
  ...
  abilities: [
    ...
    { id: 'empalar', name: 'Impale', icon: '🔱', iconImg: 'img/abilities/valkyrie/empalar.jpg', school: 'Físico', type: 'damage', requiredLevel: 2, damageType: 'physical', baseDamage: 20, spellPowerRatio: 0, costPct: 0, costRage: 10, castType: 'instant', cooldown: 0, description: 'Un golpe potente igual que un ataque básico más un daño extra que crece con el rango. Gastas 10 de ira y el 50% del daño infligido se convierte en carga de la lanza.', weaponMultiplier: 1.0, bonusPerRank: [9, 21, 36, 54] },
    ...
    { id: 'valk_last_will', name: 'Last Will', icon: '📯', iconImg: 'img/abilities/valkyrie/valkyries_call.jpg', school: 'Sagrado', type: 'utility', requiredLevel: 1, costPct: 0, costRage: 0, castType: 'instant', cooldown: 10, capstoneGate: 'last_will', description: 'Durante 3 turnos tus habilidades no gastan ira: gastan vida igual a la mitad de su coste de ira en % de tu vida maxima (10 de ira → 5% de vida) y tienes +50 Attack Power. CD 10.', buff: null },
    { id: 'valk_call_from_valhalla', name: 'Call from Valhalla', icon: '⚔️', iconImg: 'img/capstones/valkyrie/call_from_valhalla.jpg', school: 'Sagrado', type: 'utility', requiredLevel: 1, costPct: 0, costRage: 0, castType: 'cast', cooldown: 10, capstoneGate: 'call_from_valhalla', description: 'Devuelve a la vida a un aliado muerto en combate con toda su vida y le otorga +50 Attack Power y +50 Spell Power durante 2 turnos. CD 10.', buff: null },
  ],
};
