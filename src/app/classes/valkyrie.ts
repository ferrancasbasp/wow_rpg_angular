...
export const VALKYRIE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'odins_fly', name: "Odin's Fly", icon: '🦅', iconImg: 'img/abilities/valkyrie/fly_indicator.jpg', description: "La primera vez que lanzas Odin's Will en un encuentro haces un Fly the Nest gratuito: vuelas y se beneficia de sus talentos (Improved Fly the Nest).", maxRank: 1, tier: 3, requires: { id: 'improved_odins_will', points: 3 } },
