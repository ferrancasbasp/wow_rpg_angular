...
export const VALKYRIE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'valk_dive_strike', name: 'Plunge', icon: '🦅', iconImg: 'img/abilities/valkyrie/plunge.jpg', school: 'Físico', type: 'damage', requiredLevel: 10, damageType: 'physical', baseDamage: 20, spellPowerRatio: 0, costPct: 0, costRage: 15, castType: 'instant', cooldown: 0, description: 'Requiere estar volando. Igual que un ataque básico más un gran daño extra que crece mucho con el rango. El 40% del daño infligido carga la lanza. CD 0.', weaponMultiplier: 1.0, bonusPerRank: [45, 80, 125, 185] },
