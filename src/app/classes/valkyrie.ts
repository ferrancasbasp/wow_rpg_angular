...
export const VALKYRIE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'valk_odins_will', name: 'Odin\'s Will', icon: '🪽', iconImg: '', school: 'Sagrado', type: 'utility', requiredLevel: 18, costPct: 0, costRage: 0, castType: 'cast', cooldown: 4, description: 'Despliegas tus alas durante 2 turnos: desbloquea Plunge, Fly the Nest y Javelin of Lightning, regenera tus cargas de lanza y escudo hasta 100 y generas más energía. CD 4.', buff: { stat: 'valkyrie_charge_gain', duration: 2, applySelf: true }, buffRanks: [{ rank: 1, level: 18, value: 50 }, { rank: 2, level: 26, value: 75 }, { rank: 3, level: 34, value: 100 }] },
