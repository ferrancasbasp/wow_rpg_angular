...
export const VALKYRIE: CharacterClass = {
  ...
  talents: [
    { id: 'valk_recover_magic', name: 'Absortion of Magic', icon: '🔮', iconImg: 'img/talents/valkyrie/absortion_of_magic.jpg', description: 'Pasiva: al recibir daño mágico, un 30% del daño por punto se añade a tu carga de escudo.', maxRank: 3, tier: 1, requires: null },
    ...
    { id: 'improved_abs_magic', name: 'Improved ABS Magic', icon: '✨', iconImg: 'img/talents/valkyrie/absortion_of_magic.jpg', description: 'Aumenta la carga de energía de la pasiva Absortion of Magic un 5% por punto.', maxRank: 3, tier: 1, requires: null },
    ...
    { id: 'improved_fly_the_nest', name: 'Improved Fly the Nest', icon: '🕊️', iconImg: 'img/abilities/valkyrie/fly_the_nest.jpg', description: 'Fly the Nest te da energía de lanza y escudo igual a tu nivel por punto.', maxRank: 3, tier: 2, requires: null },
  ...
  abilities: [
    ...
    { id: 'shield_bash', name: 'Slam', icon: '🛡️', iconImg: 'img/abilities/valkyrie/slam.jpg', school: 'Físico', type: 'damage', requiredLevel: 4, damageType: 'physical', baseDamage: 0, spellPowerRatio: 0, costPct: 0, costRage: 5, castType: 'instant', cooldown: 0, description: 'Golpea con el escudo: el daño escala con la armadura de tu escudo más un bonus que crece con tu nivel, no con tu arma. Gastas 5 de ira, provocas y ganas carga de escudo igual al 100% del daño infligido.' },
    ...
    { id: 'valk_take_flight', name: 'Fly the Nest', icon: '🕊️', iconImg: 'img/abilities/valkyrie/fly_the_nest.jpg', school: 'Físico', type: 'utility', requiredLevel: 18, costPct: 0, costRage: 0, castType: 'instant', cooldown: 0, description: 'Alzas el vuelo durante 2 turnos y no puedes ser impactado. Solo usable mientras dura Odin\'s Will.', buff: null },
    { id: 'valk_dive_strike', name: 'Plunge', icon: '🦅', iconImg: 'img/abilities/valkyrie/plunge.jpg', school: 'Físico', type: 'damage', requiredLevel: 20, damageType: 'physical', baseDamage: 20, spellPowerRatio: 0, costPct: 0, costRage: 15, castType: 'instant', cooldown: 0, description: 'Requiere estar volando. Igual que un ataque básico más un gran daño extra que crece mucho con el rango. CD 0.', weaponMultiplier: 1.0, bonusPerRank: [45, 80, 125, 185] },
