...
export const VALKYRIE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'odins_fly', name: "Odin's Fly", icon: '🦅', iconImg: 'img/abilities/valkyrie/fly_indicator.jpg', description: "La primera vez que lanzas Odin's Will en un encuentro también obtienes el estado volando (se consume al hacer Plunge).", maxRank: 1, tier: 3, requires: { id: 'improved_odins_will', points: 3 } },
