...
export const WARRIOR: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'bloodrage', name: 'Blood Rage', icon: '🩸', iconImg: 'img/abilities/warrior/bloodrage.jpg', school: 'Físico', type: 'utility', requiredLevel: 2, costPct: 0, costRage: 0, castType: 'instant', cooldown: 6, noGcd: true, rageGain: 20, healthCostPct: 0.15, description: 'Pierde 15% de vida máxima y gana 20 de ira. No usable en estancia Defensiva.', buff: null, blockedStance: 'protection' },
