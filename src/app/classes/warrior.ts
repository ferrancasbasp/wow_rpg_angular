...
export const WARRIOR: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'master_of_weapons', name: 'Master of Weapons', icon: '⚔️', iconImg: 'img/talents/warrior/master_of_weapons.jpg', school: 'Pasiva', type: 'utility', requiredLevel: 8, costPct: 0, costRage: 0, castType: 'instant', passive: true, description: 'Pasiva aprendida al nivel 8: desbloquea el uso de armas a dos manos y permite combinar arma de una mano con off hand. Los stats de ambos se acumulan.' },
