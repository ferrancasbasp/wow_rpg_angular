...
export const WARRIOR: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'sunder_armor', name: 'Sunder Armor', icon: '🛡️', iconImg: 'img/abilities/warrior/taunt.jpg', school: 'Físico', type: 'damage', requiredLevel: 14, damageType: 'physical', baseDamage: 0, spellPowerRatio: 0, costPct: 0, costRage: 10, castType: 'instant', cooldown: 0, noWeaponScaling: true, description: 'Golpe que destroza la armadura del enemigo: reduce su armadura en 8 y se acumula hasta 5 veces (máx −40).', damageRanges: [{ rank: 1, level: 14, min: 6, max: 10 }, { rank: 2, level: 20, min: 12, max: 18 }, { rank: 3, level: 26, min: 20, max: 30 }], inflictsEffects: [{ type: 'debuff', name: 'Armadura Destrozada', stat: 'armor', value: 8, duration: 4, stackable: true, maxStacks: 5, debuffType: 'none' }] },
