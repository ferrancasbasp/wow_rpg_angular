...
export const WARRIOR: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'battle_flow', name: 'Battle Flow', icon: '🔄', iconImg: 'img/talents/warrior/battle_flow.jpg', description: 'Al cambiar de postura, conservas el beneficio de la postura anterior durante 1 turno por punto. No puedes tener el beneficio de una misma postura dos veces.', maxRank: 3, tier: 3, requires: null },
