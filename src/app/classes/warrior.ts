...
export const WARRIOR: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'improved_last_stand', name: 'Improved Last Stand', icon: '🛡️', iconImg: 'img/abilities/warrior/spell_holy_ashes_to_ashes.jpg', description: 'Last Stand te cura un 5% de vida por punto y reduce su cooldown en 1 turno por punto.', maxRank: 2, tier: 3, requires: null },
    ...
    { id: 'improved_battle_shout', name: 'Improved Battle Shout', icon: '📢', iconImg: 'img/abilities/warrior/battle_shout.jpg', description: 'Aumenta el AP otorgado por Battle Shout un 6% y reduce su coste de ira en 2 por punto.', maxRank: 3, tier: 2, requires: null },
    { id: 'deep_wounds', name: 'Deep Wounds', icon: '🩸', iconImg: 'img/abilities/warrior/deep_wounds.jpg', description: 'Tus golpes críticos dejan una herida sangrante: un DoT del 10% del daño del crítico por punto durante 3 turnos.', maxRank: 3, tier: 3, requires: null },
    { id: 'battle_flow', name: 'Battle Flow', icon: '🔄', iconImg: 'img/talents/warrior/improved_stances.jpg', description: 'Al cambiar de postura, conservas el beneficio de la postura anterior durante 1 turno por punto. No puedes tener el beneficio de una misma postura dos veces.', maxRank: 3, tier: 3, requires: null },
  ...
  abilities: [
    ...
    { id: 'bloodrage', name: 'Blood Rage', icon: '🩸', iconImg: 'img/abilities/warrior/bloodrage.jpg', school: 'Físico', type: 'utility', requiredLevel: 2, costPct: 0, costRage: 0, castType: 'instant', cooldown: 5, noGcd: true, rageGain: 20, healthCostPct: 0.15, description: 'Pierde 15% de vida máxima y gana 20 de ira. Otorga 5 de ira por turno durante 2 turnos. No usable en estancia Defensiva.', buff: { stat: 'bloodrage', duration: 2, applySelf: true }, buffRanks: [{ rank: 1, level: 2, value: 5, costRage: 0 }], blockedStance: 'protection' },
    { id: 'last_stand', name: 'Last Stand', icon: '🛡️', iconImg: 'img/abilities/warrior/spell_holy_ashes_to_ashes.jpg', school: 'Físico', type: 'utility', requiredLevel: 18, costPct: 0, costRage: 0, castType: 'instant', cooldown: 10, noGcd: true, description: 'Aumenta tu vida máxima un 20% durante 4 turnos. El % de vida actual se mantiene.', buff: { stat: 'maxHP', duration: 4, applySelf: true, isPercent: true }, buffRanks: [{ rank: 1, level: 18, value: 20, costRage: 0 }] },
    ...
    { id: 'group_last_stand', name: 'Rallying Cry', icon: '🏰', iconImg: 'img/abilities/warrior/ability_warrior_rallying_cry.jpg', school: 'Físico', type: 'utility', requiredLevel: 20, costPct: 0, costRage: 0, castType: 'instant', cooldown: 6, noGcd: true, description: 'Aumenta la vida máxima de todo el grupo un 15% durante 4 turnos.', buff: { stat: 'maxHP', duration: 4, applySelf: false, isPercent: true }, partyBuff: true, buffRanks: [{ rank: 1, level: 20, value: 15, costRage: 0 }, { rank: 2, level: 28, value: 20, costRage: 0 }] },
  ],
};
