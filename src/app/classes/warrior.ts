...
export const WARRIOR: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'improved_stances', name: 'Improved Stances', icon: '🛡️', iconImg: '', description: 'Aumenta la armadura de Protection en 4, el crítico de Fury en 2% y el daño de Battle en 2% por punto.', maxRank: 3, tier: 2, requires: null },
