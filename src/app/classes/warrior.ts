...
export const WARRIOR: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'anticipation', name: 'Anticipation', icon: '🛡️', iconImg: 'img/abilities/warrior/last_stand.jpg', description: 'Aumenta tu armadura física y mágica en 2 por punto.', maxRank: 3, tier: 1, requires: null },
  ...
  capstones: [
    ...
    { id: 'colossus_smash', name: 'Colossus Smash', icon: '🗿', iconImg: 'img/capstones/warrior/colossus_smash.jpg', description: 'Golpea brutalmente al objetivo infligiendo el doble del daño de tu arma y destroza su armadura (−30) durante 2 turnos. Cuesta 15 de ira. CD 4.' },
  ],
  ...
  abilities: [
    ...
    { id: 'colossus_smash', name: 'Colossus Smash', icon: '🗿', iconImg: 'img/capstones/warrior/colossus_smash.jpg', school: 'Físico', type: 'utility', requiredLevel: 1, costPct: 0, costRage: 15, castType: 'instant', cooldown: 4, description: 'Golpe bestia: inflige el doble del dano de tu arma y destroza la armadura del enemigo (−30) durante 2 turnos. Cuesta 15 de ira. CD 4.', buff: null, capstoneGate: 'colossus_smash' },
