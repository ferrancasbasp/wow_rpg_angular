...
export const WARRIOR: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'bloodrage', name: 'Blood Rage', icon: '🩸', iconImg: 'img/abilities/warrior/bloodrage.jpg', school: 'Físico', type: 'utility', requiredLevel: 2, costPct: 0, costRage: 0, castType: 'instant', cooldown: 10, description: 'Pierde 15% de vida máxima y gana 20 de ira. No usable en estancia Defensiva.', buff: null, blockedStance: 'protection' },
    { id: 'last_stand', name: 'Last Stand', icon: '🛡️', iconImg: 'img/abilities/warrior/last_stand.jpg', school: 'Físico', type: 'utility', requiredLevel: 18, costPct: 0, costRage: 0, castType: 'instant', cooldown: 10, description: 'Aumenta tu vida máxima un 20% durante 4 turnos. El % de vida actual se mantiene.', buff: { stat: 'maxHP', duration: 4, applySelf: true, isPercent: true }, buffRanks: [{ rank: 1, level: 18, value: 20, costRage: 0 }] },
    { id: 'group_last_stand', name: 'Iron Wall', icon: '🏰', iconImg: '', school: 'Físico', type: 'utility', requiredLevel: 36, costPct: 0, costRage: 0, castType: 'instant', cooldown: 8, description: 'Aumenta la vida máxima de todo el grupo un 20% durante 4 turnos. Cada jugador debe aplicarse el buff manualmente.', buff: { stat: 'maxHP', duration: 4, applySelf: false, isPercent: true }, buffRanks: [{ rank: 1, level: 36, value: 20, costRage: 0 }] },
  ],
};
