...
export const HUNTER: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'swift_strike', name: 'Swift Strike', icon: '⚡', iconImg: 'img/abilities/hunter/swift_strike.jpg', school: 'Físico', type: 'damage', requiredLevel: 4, damageType: 'physical', baseDamage: 0, spellPowerRatio: 0, costPct: 0, costFocus: 0, focusGain: 8, castType: 'instant', cooldown: 0, description: 'Golpe rapido con tu arma que no gasta focus y genera 8 Focus.', usesWeaponDamage: true },
    ...
    { id: 'sniper_shot', name: 'Sniper Shot', icon: '🎯', iconImg: 'img/abilities/hunter/sniper_shot.jpg', school: 'Físico', type: 'damage', requiredLevel: 14, damageType: 'physical', baseDamage: 1, spellPowerRatio: 0, costPct: 0, costFocus: 35, castType: 'cast', cooldown: 2, description: 'Disparo de precision: dano fisico elevado (suma el arma). Cuesta 35 Focus. CD 2.', damageRanges: [{ rank: 1, level: 14, min: 150, max: 200 }, { rank: 2, level: 22, min: 260, max: 340 }, { rank: 3, level: 30, min: 400, max: 500 }, { rank: 4, level: 38, min: 620, max: 760 }] },
