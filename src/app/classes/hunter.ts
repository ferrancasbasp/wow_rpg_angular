...
export const HUNTER: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'explosive_shot', name: 'Explosive Shot', icon: '💥', iconImg: 'img/capstones/hunter/explosive_shot.jpg', school: 'Fuego', type: 'utility', requiredLevel: 0, costPct: 0, costFocus: 50, castType: 'cast', cooldown: 5, description: 'Coste: 50 Focus. Dispara un proyectil que se incrusta 3 turnos: dano de Fuego cada turno al objetivo y a los enemigos cercanos. CD 5.', capstoneGate: 'explosive_shot', buff: null, damageRanges: [{ rank: 1, level: 1, min: 54, max: 84 }, { rank: 2, level: 20, min: 96, max: 138 }, { rank: 3, level: 40, min: 150, max: 204 }] },
  ],
