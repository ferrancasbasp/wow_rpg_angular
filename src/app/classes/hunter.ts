...
export const HUNTER: CharacterClass = {
  ...
  talents: [
    { id: 'ranged_weapon_spec', name: 'Ranged Weapon Specialization', icon: '🏹', iconImg: 'img/talents/hunter/ranged_weapon_spec.jpg', description: 'Aumenta el dano de Auto Shot, Arcane Shot, Aimed Shot y Multi-Shot un 2% por punto.', maxRank: 3, tier: 1, requires: null },
    ...
    { id: 'improved_hunters_mark', name: "Improved Hunter's Mark", icon: '🎯', iconImg: 'img/abilities/hunter/hunters_mark.jpg', description: "Aumenta la reduccion de Armor de Hunter's Mark un 10% por punto.", maxRank: 3, tier: 2, requires: null },
    { id: 'improved_aimed_shot', name: 'Improved Aimed Shot', icon: '🎯', iconImg: 'img/abilities/hunter/aimed_shot.jpg', description: 'Reduce el coste de Aimed Shot en 5 Focus por punto.', maxRank: 3, tier: 2, requires: null },
    ...
    { id: 'mortal_shots', name: 'Mortal Shots', icon: '💀', iconImg: 'img/talents/hunter/mortal_shots.jpg', description: 'Aumenta el dano de los criticos de tus disparos un 5% por punto.', maxRank: 3, tier: 3, requires: null },
    { id: 'ferocious_inspiration', name: 'Ferocious Inspiration', icon: '🦁', iconImg: 'img/talents/hunter/ferocious_inspiration.jpg', description: 'Mejora tus pets: Furious Howl tambien beneficia a toda la party (1 punto = 50% efectividad = +5% Attack Power, 2 puntos = 100% = +10%); Growl da Thick Skin al Bear (+8/+15 Armor) 3 turnos.', maxRank: 2, tier: 3, requires: null },
  ...
  capstones: [
    { id: 'lone_wolf', name: 'Lone Wolf', icon: '🐺', iconImg: 'img/capstones/hunter/lone_wolf.jpg', description: 'No puedes tener un pet activo durante el resto del combate. Tienes 1 accion adicional por turno.' },
  ...
  abilities: [
    ...
    { id: 'aspect_of_the_hawk', name: 'Aspect of the Hawk', icon: '🦅', iconImg: 'img/abilities/hunter/aspect_of_the_hawk.jpg', school: 'Físico', type: 'utility', requiredLevel: 2, costPct: 0, costFocus: 5, castType: 'instant', cooldown: 0, description: 'Aumenta tu Attack Power en +20 por rango durante 30 turnos. Solo un Aspect activo. Cuesta 5 Focus.', buffRanks: [{ rank: 1, level: 2, value: 20 }, { rank: 2, level: 12, value: 40 }, { rank: 3, level: 22, value: 60 }, { rank: 4, level: 32, value: 80 }], buff: { stat: 'attackPower', duration: 30, applySelf: true } },
    { id: 'aspect_of_the_monkey', name: 'Aspect of the Monkey', icon: '🐒', iconImg: 'img/abilities/hunter/aspect_of_the_monkey.jpg', school: 'Físico', type: 'utility', requiredLevel: 8, costPct: 0, costFocus: 5, castType: 'instant', cooldown: 0, description: 'Aumenta tu Dodge +6% y +2% por rango durante 30 turnos. Solo un Aspect activo. Cuesta 5 Focus.', buffRanks: [{ rank: 1, level: 8, value: 6 }, { rank: 2, level: 18, value: 8 }, { rank: 3, level: 28, value: 10 }, { rank: 4, level: 38, value: 12 }], buff: { stat: 'evasion', duration: 30, applySelf: true } },
    ...
    { id: 'furious_howl', name: 'Furious Howl', icon: '🐺', iconImg: 'img/abilities/hunter/furious_howl.jpg', school: 'Bestial', type: 'utility', requiredLevel: 4, costPct: 0, castType: 'instant', cooldown: 3, description: 'El Wolf aulla: Attack Power del Hunter +10%, dano del Wolf y de Kill Command +10% durante 3 turnos. CD 3.', petAbility: 'wolf', buffRanks: [{ rank: 1, level: 4, value: 10 }], buff: { stat: 'attackPower', duration: 3, applySelf: true, isPercent: true } },
    ...
    { id: 'explosive_shot', name: 'Explosive Shot', icon: '💥', iconImg: 'img/capstones/hunter/explosive_shot.jpg', school: 'Fuego', type: 'utility', requiredLevel: 0, costPct: 0, costFocus: 50, castType: 'cast', cooldown: 3, description: 'Coste: 50 Focus. Dispara un proyectil que impacta de inmediato con dano de Fuego en área y se incrusta dejando un DOT de Fuego cada turno durante 3 turnos, también en área. CD 3.', capstoneGate: 'explosive_shot', buff: null, damageRanges: [{ rank: 1, level: 1, min: 54, max: 84 }, { rank: 2, level: 20, min: 96, max: 138 }, { rank: 3, level: 40, min: 150, max: 204 }] },
  ],
