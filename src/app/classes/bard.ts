...
export const BARD: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'rinforzando', name: 'Rinforzando', icon: '💪', iconImg: '', description: 'Aumenta el danyo de Scherzo y Sforzando un 4% por punto.', maxRank: 3, tier: 3, requires: null, branch: 2 },
