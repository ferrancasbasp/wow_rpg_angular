...
export const BARD: CharacterClass = {
  ...
  abilities: [
    { id: 'staccato', name: 'Staccato', icon: '🤺', iconImg: 'img/abilities/bard/staccato.jpg', school: 'Físico', type: 'damage', requiredLevel: 1, damageType: 'physical', baseDamage: 20, spellPowerRatio: 0, costPct: 0.02, castType: 'instant', cooldown: 0, usesWeaponDamage: true, generatesNote: 1, description: 'Una estocada rapida y precisa. Genera un Do.' },
    { id: 'scherzo', name: 'Scherzo', icon: '🎭', iconImg: 'img/abilities/bard/scherzo.jpg', school: 'Físico', type: 'damage', requiredLevel: 4, damageType: 'physical', baseDamage: 35, spellPowerRatio: 0.3, costPct: 0.12, castType: 'instant', cooldown: 1, weaponMultiplier: 1.0, generatesNote: 2, description: 'Una finta engañosa que inflige daño adicional. Genera un Re.', bonusPerRank: [12, 24, 38, 55] },
    ...
    { id: 'crescendo', name: 'Crescendo', icon: '📈', iconImg: 'img/abilities/bard/crescendo.jpg', school: 'Magia', type: 'utility', requiredLevel: 8, costPct: 0.12, castType: 'instant', cooldown: 1, modulateNotes: 1, buff: { stat: 'damage_boost', duration: 3, applySelf: false }, description: 'Otorga a un aliado +10 de dano en su proximo ataque. Se consume al atacar. Sube el tono de las notas.', buffRanks: [{ rank: 1, level: 8, value: 10, costPct: 0.12 }, { rank: 2, level: 16, value: 15, costPct: 0.12 }, { rank: 3, level: 24, value: 20, costPct: 0.14 }] },
