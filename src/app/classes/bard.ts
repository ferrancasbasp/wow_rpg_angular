...
export const BARD: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'crescendo', name: 'Crescendo', icon: '📈', iconImg: '', school: 'Magia', type: 'utility', requiredLevel: 8, costPct: 0.12, castType: 'instant', cooldown: 1, modulateNotes: 1, buff: { stat: 'damage_boost', duration: 1, applySelf: false }, description: 'Otorga a un aliado +10 de dano en su proximo ataque. Sube el tono de las notas.', buffRanks: [{ rank: 1, level: 8, value: 10, costPct: 0.12 }, { rank: 2, level: 16, value: 15, costPct: 0.12 }, { rank: 3, level: 24, value: 20, costPct: 0.14 }] },
