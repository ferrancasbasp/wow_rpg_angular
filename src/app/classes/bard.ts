...
export const BARD: CharacterClass = {
  ...
  capstones: [
    ...
    { id: 'perfect_symphony', name: 'Perfect Symphony', icon: '🎻', iconImg: 'img/capstones/bard/perfect_symphony.jpg', description: 'Pasiva. Cuando tienes la partitura completa (7 notas), el multiplicador total de tus notas aumenta un 15%.' },
  ],
  ...
  abilities: [
    ...
    { id: 'sforzando', name: 'Sforzando', icon: '💢', iconImg: '', school: 'Físico', type: 'damage', requiredLevel: 4, damageType: 'physical', baseDamage: 35, spellPowerRatio: 0.3, costPct: 0, castType: 'instant', cooldown: 5, weaponMultiplier: 1.0, description: 'Un golpe repentino y contundente a un unico objetivo. Pierdes la nota mas alta de tu partitura (si tienes alguna).', bonusPerRank: [24, 44, 65, 92] },
    ...
    { id: 'fortissimo', name: 'Fortissimo', icon: '💥', iconImg: 'img/abilities/bard/fortissimo.jpg', school: 'Magia', type: 'damage', requiredLevel: 16, damageType: 'magical', aoe: true, baseDamage: 15, spellPowerRatio: 0.4, costPct: 0.10, castType: 'cast', cooldown: 0, spendsNotes: true, description: 'Remate devastador en area. Consume todas las notas. El dano escala con el valor de las notas gastadas.', damageRanges: [{ rank: 1, level: 16, min: 9, max: 13 }, { rank: 2, level: 24, min: 15, max: 21 }, { rank: 3, level: 32, min: 23, max: 31 }] },
    ...
    { id: 'finale', name: 'Finale', icon: '🎤', iconImg: 'img/capstones/bard/finale.jpg', school: 'Magia', type: 'utility', requiredLevel: 0, damageType: 'magical', aoe: false, spellPowerRatio: 0.8, costPct: 0.10, castType: 'cast', cooldown: 0, spendsNotes: true, description: 'Remate de daño a un único objetivo. Consume todas las notas. El dano escala con el valor de las notas gastadas.', buff: null, capstoneGate: 'finale', damageRanges: [{ rank: 1, level: 16, min: 18, max: 26 }, { rank: 2, level: 24, min: 30, max: 42 }, { rank: 3, level: 32, min: 46, max: 62 }] },
