...
export const BARD: CharacterClass = {
  ...
  capstones: [
    ...
    { id: 'improved_da_capo', name: 'Improved Da Capo', icon: '🎺', iconImg: 'img/capstones/bard/improved_da_capo.jpg', description: 'Pasiva. Da Capo dura 1 turno más y además otorga un buff de Espíritu a todo el grupo (incluido tú) durante la misma duración.' },
