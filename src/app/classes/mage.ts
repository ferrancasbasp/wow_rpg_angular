...
export const MAGE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'ignite', name: 'Ignite', icon: '🔥', iconImg: 'img/talents/mage/ignite.jpg', description: 'Un golpe critico con un hechizo de Fuego prende un DoT ardiente del 8% del daño por punto durante 3 turnos. Los Ignites se apilan como DoTs independientes.', maxRank: 5, tier: 1, requires: null },
    ...
    { id: 'improved_frost_armor', name: 'Improved Frost Armor', icon: '🧊', iconImg: 'img/abilities/mage/frost_armor.jpg', description: 'Aumenta el efecto de Frost Armor un 10% por punto.', maxRank: 3, tier: 2, requires: null },
    { id: 'casting_master', name: 'Casting Master', icon: '📜', iconImg: 'img/talents/mage/casting_master.jpg', description: 'Aumenta el daño de todos tus hechizos con tiempo de lanzamiento un 5% por punto.', maxRank: 3, tier: 2, requires: null },
    ...
    { id: 'improved_fire_blast', name: 'Improved Fire Blast', icon: '💥', iconImg: 'img/abilities/mage/fire_blast.jpg', description: 'Reduce el cooldown de Fire Blast 1 turno por punto.', maxRank: 2, tier: 3, requires: null },
