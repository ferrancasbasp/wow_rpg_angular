...
export const MAGE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'frost_power', name: 'Frost Power', icon: '❄️', iconImg: 'img/talents/mage/frost_power.jpg', description: 'Aumenta el daño de tus hechizos de Escarcha un 10% por punto, su probabilidad de crítico un 2% y su daño crítico un 10% por punto.', maxRank: 3, tier: 3, requires: null },
