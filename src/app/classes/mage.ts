...
export const MAGE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'remove_curse', name: 'Remove Curse', icon: '✨', iconImg: '', school: 'Arcano', type: 'utility', requiredLevel: 12, costPct: 0.05, castType: 'instant', cooldown: 0, description: 'Elimina una maldicion del objetivo.', bonusPerRank: [0, 0, 0] },
  ],
};
