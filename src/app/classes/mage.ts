...
export const MAGE: CharacterClass = {
  ...
  capstones: [
    { id: 'combustion', name: 'Combustion', icon: '🔥', iconImg: 'img/capstones/mage/combustion.jpg', description: 'Durante 3 turnos, aumenta la probabilidad de golpe crítico y el daño crítico de tus spells de Fuego en 25%. CD 5.' },
  ...
  abilities: [
    ...
    { id: 'combustion', name: 'Combustion', icon: '🔥', iconImg: 'img/capstones/mage/combustion.jpg', school: 'Fuego', type: 'utility', requiredLevel: 1, costPct: 0, castType: 'instant', cooldown: 5, noGcd: true, description: 'Durante 3 turnos, aumenta la probabilidad de golpe critico y el danyo critico de tus spells de Fuego en 25%. CD 5.', buff: null, capstoneGate: 'combustion' },
    { id: 'icy_veins', name: 'Icy Veins', icon: '🧊', iconImg: 'img/capstones/mage/icy_veins.jpg', school: 'Escarcha', type: 'utility', requiredLevel: 1, costPct: 0, castType: 'instant', cooldown: 5, noGcd: true, description: 'Durante 2 turnos, tus hechizos de Escarcha se lanzan de forma instantanea y solo consumen un punto de accion.', buff: null, capstoneGate: 'icy_veins' },
    { id: 'arcane_power', name: 'Arcane Power', icon: '⚡', iconImg: 'img/capstones/mage/arcane_power.jpg', school: 'Arcano', type: 'utility', requiredLevel: 1, costPct: 0, castType: 'instant', cooldown: 5, noGcd: true, description: 'Durante 2 turnos, tus spells no consumen mana, tu Spell Power aumenta un 20% y tu danyo critico un 25%. Al final de cada turno recuperas un 20% de tu mana maximo. CD 5.', buff: null, capstoneGate: 'arcane_power' },
