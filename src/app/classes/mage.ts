...
export const MAGE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'ice_barrier', name: 'Ice Barrier', icon: '🧊', iconImg: 'img/abilities/mage/ice_barrier.jpg', school: 'Escarcha', type: 'heal', requiredLevel: 10, baseDamage: 80, spellPowerRatio: 0.5, costPct: 0.03, castType: 'instant', cooldown: 3, description: 'Crea un escudo de hielo que absorbe daño.', damageRanges: [{ rank: 1, level: 10, min: 60, max: 60 }, { rank: 2, level: 18, min: 120, max: 120 }, { rank: 3, level: 26, min: 200, max: 200 }] },
    { id: 'arcane_missiles', name: 'Arcane Missiles', icon: '✨', iconImg: 'img/abilities/mage/arcane_missiles.jpg', school: 'Arcano', type: 'damage', requiredLevel: 14, baseDamage: 50, spellPowerRatio: 0.571, costPct: 0.10, castType: 'cast', cooldown: 1, description: 'Dispara misiles de energía arcana al objetivo cada segundo.', damageRanges: [{ rank: 1, level: 14, min: 32, max: 32 }, { rank: 2, level: 20, min: 56, max: 56 }, { rank: 3, level: 26, min: 92, max: 92 }] },
