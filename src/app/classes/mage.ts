...
export const MAGE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'combustion', name: 'Combustion', icon: '🔥', iconImg: 'img/capstones/mage/combustion.jpg', school: 'Fuego', type: 'utility', requiredLevel: 1, costPct: 0, castType: 'instant', cooldown: 0, noGcd: true, description: 'Durante 2 turnos, aumenta la probabilidad de golpe critico y el danyo critico de tus spells de Fuego en 25%.', buff: null, capstoneGate: 'combustion' },
