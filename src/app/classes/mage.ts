...
export const MAGE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'frost_armor', name: 'Frost Armor', icon: '🧊', iconImg: 'img/abilities/mage/frost_armor.jpg', school: 'Escarcha', type: 'utility', requiredLevel: 4, costPct: 0.30, castType: 'instant', cooldown: 0, description: 'Crea una barrera de hielo que aumenta tu armadura física.', buff: { stat: 'armor', duration: 30, applySelf: true }, buffRanks: [{ rank: 1, level: 4, value: 6, costPct: 0.30 }, { rank: 2, level: 14, value: 8, costPct: 0.30 }, { rank: 3, level: 24, value: 11, costPct: 0.30 }, { rank: 4, level: 34, value: 13, costPct: 0.30 }, { rank: 5, level: 44, value: 16, costPct: 0.30 }, { rank: 6, level: 54, value: 18, costPct: 0.30 }] },
