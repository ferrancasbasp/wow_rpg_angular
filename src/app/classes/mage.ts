...
export const MAGE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'magic_resistance', name: 'Magic Resistance', icon: '🛡️', iconImg: 'img/talents/mage/magic_resistance.jpg', description: 'Aumenta tu armadura mágica +5 por punto y tu probabilidad de crítico con hechizos instantáneos un 1% por punto.', maxRank: 3, tier: 2, requires: null },
    ...
    { id: 'arcane_torrent', name: 'Arcane Torrent', icon: '⚡', iconImg: 'img/abilities/mage/arcane_missiles.jpg', description: 'Aumenta el daño y el coste de maná de Arcane Missiles y Arcane Explosion un 10% por punto.', maxRank: 3, tier: 3, requires: null },
  ...
  abilities: [
    ...
    { id: 'frost_armor', name: 'Frost Armor', icon: '🧊', iconImg: 'img/abilities/mage/frost_armor.jpg', school: 'Escarcha', type: 'utility', requiredLevel: 4, costPct: 0.30, castType: 'instant', cooldown: 0, description: 'Crea una barrera de hielo que aumenta tu armadura física.', buff: { stat: 'armor', duration: 30, applySelf: true }, buffRanks: [{ rank: 1, level: 4, value: 15, costPct: 0.30 }, { rank: 2, level: 14, value: 22, costPct: 0.30 }, { rank: 3, level: 24, value: 32, costPct: 0.30 }, { rank: 4, level: 34, value: 45, costPct: 0.30 }, { rank: 5, level: 44, value: 60, costPct: 0.30 }, { rank: 6, level: 54, value: 80, costPct: 0.30 }] },
