...
export const PRIEST: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'renew', name: 'Renew', icon: '🌿', iconImg: 'img/abilities/priest/renew.jpg', school: 'Sagrado', category: 'holy', type: 'heal', requiredLevel: 4, baseDamage: 100, spellPowerRatio: 1.0, costPct: 0.07, castType: 'instant', cooldown: 0, description: 'HoT que cura cada turno. Aplicar manualmente en Efectos.', isHot: true, hotDuration: 5, damageRanges: [{ rank: 1, level: 4, min: 75, max: 75 }, { rank: 2, level: 10, min: 140, max: 140 }, { rank: 3, level: 16, min: 220, max: 220 }, { rank: 4, level: 22, min: 320, max: 320 }, { rank: 5, level: 28, min: 450, max: 450 }] },
    ...
    { id: 'mind_spike', name: 'Mind Spike', icon: '🔮', iconImg: 'img/abilities/priest/mind_spike.jpg', school: 'Sombra', category: 'shadow', type: 'damage', requiredLevel: 20, damageType: 'magical', baseDamage: 40, spellPowerRatio: 0.571, costPct: 0.06, castType: 'cast', cooldown: 0, description: 'Lanza de sombra rápida. Daño moderado sin cooldown.', damageRanges: [{ rank: 1, level: 20, min: 56, max: 72 }, { rank: 2, level: 26, min: 88, max: 110 }, { rank: 3, level: 32, min: 130, max: 160 }, { rank: 4, level: 38, min: 184, max: 224 }] },
    ...
    { id: 'flash_heal', name: 'Flash Heal', icon: '⚡', iconImg: 'img/abilities/priest/flash_heal.jpg', school: 'Sagrado', category: 'holy', type: 'heal', requiredLevel: 14, baseDamage: 30, spellPowerRatio: 0.714, costPct: 0.12, castType: 'cast', cooldown: 0, description: 'Curación rápida. Más rápida pero menos eficiente que Heal.', damageRanges: [{ rank: 1, level: 14, min: 80, max: 100 }, { rank: 2, level: 20, min: 130, max: 156 }, { rank: 3, level: 26, min: 200, max: 236 }, { rank: 4, level: 32, min: 290, max: 338 }] },
