...
export const PRIEST: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'beligerance', name: 'Beligerance', icon: '⚔️', iconImg: 'img/talents/priest/beligerance.jpg', description: 'Tu ataque básico usa el Espiritu como poder de ataque, sumandolo al danyo fisico. 20% del Espiritu por punto.', maxRank: 5, tier: 1, requires: null },
