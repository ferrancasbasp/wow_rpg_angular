...
export const PRIEST: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'improved_mind_blast', name: 'Improved Mind Blast', icon: '💥', iconImg: 'img/talents/priest/improved_mind_blast.jpg', description: 'Aumenta la probabilidad de crítico de Mind Blast un 10% por punto. Al tenerlo a tope: Mind Blast tiene CD -1 y su cast se vuelve instantaneo.', maxRank: 3, tier: 3, requires: null },
  ...
  abilities: [
    ...
    { id: 'inner_fire', name: 'Inner Fire', icon: '🔥', iconImg: 'img/abilities/priest/inner_fire.jpg', school: 'Sagrado', category: 'discipline', type: 'utility', requiredLevel: 8, costPct: 0, castType: 'instant', cooldown: 0, description: 'El fuego interior arde: aumenta tu Armor y tu Attack Power. Escala con tu nivel.', buff: { stat: 'armor', duration: 999, applySelf: true }, buffRanks: [{ rank: 1, level: 8, value: 5 }, { rank: 2, level: 16, value: 10 }, { rank: 3, level: 24, value: 15 }, { rank: 4, level: 32, value: 20 }] },
    {
      id: 'holy_nova',
      name: 'Holy Nova',
      icon: '✨',
