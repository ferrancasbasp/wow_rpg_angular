...
export const WARLOCK: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'grimoire_of_command', name: 'Grimoire of Command', icon: '📖', iconImg: 'img/talents/warlock/grimoire_of_command.jpg', description: 'Fortalece a tus demonios: aumenta el dano del Imp y la vida del Voidwalker un 25% por punto.', maxRank: 3, tier: 2, requires: null },
