...
export const ROGUE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'sprint', name: 'Sprint', icon: '🏃', iconImg: 'img/abilities/rogue/sprint.jpg', school: 'Físico', type: 'utility', requiredLevel: 10, costPct: 0, costEnergy: 0, castType: 'instant', cooldown: 6, noGcd: true, description: 'Acción gratuita que te permite moverte en el turno.', buff: null },
