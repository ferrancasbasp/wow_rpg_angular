...
export const ROGUE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'sprint', name: 'Sprint', icon: '🏃', iconImg: 'img/abilities/rogue/sprint.jpg', school: 'Físico', type: 'utility', requiredLevel: 10, costPct: 0, costEnergy: 0, castType: 'instant', cooldown: 6, noGcd: true, description: 'Te permite moverte una vez sin gastar acción. CD 6 turnos.', buff: null },
