...
export const ROGUE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'improved_energetic_attacks', name: 'Improved Energetic Attacks', icon: '👊', iconImg: 'img/abilities/rogue/basic_attack.jpg', description: 'Mejora la pasiva Energetic Basic Attack: +50/100/150/200% de energía por Basic Attack (redondeado hacia abajo) y +1% de probabilidad de crítico con Basic Attack por punto. Con 4 puntos igualas la generación de energía del talento original.', maxRank: 4, tier: 1, requires: null },
  ...
  abilities: [
    ...
    { id: 'leeching_poison', name: 'Veneno Vampírico', icon: '🩸', iconImg: 'img/abilities/rogue/leeching_poison.jpg', school: 'Físico', type: 'utility', requiredLevel: 20, costPct: 0, costEnergy: 0, castType: 'instant', cooldown: 0, description: 'Envenena tu arma: te curas un % del daño que haces y tus ataques pasan a ser de tipo mágico. No aumenta el daño. Incompatible con Veneno Mortal.', buff: { stat: 'leechPoison', duration: 5, applySelf: true }, buffRanks: [{ rank: 1, level: 20, value: 14, costEnergy: 0 }, { rank: 2, level: 28, value: 16, costEnergy: 0 }, { rank: 3, level: 36, value: 18, costEnergy: 0 }, { rank: 4, level: 44, value: 20, costEnergy: 0 }] },
