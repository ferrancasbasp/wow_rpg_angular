...
export const ROGUE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'improved_energetic_attacks', name: 'Improved Energetic Attacks', icon: '👊', iconImg: 'img/abilities/rogue/basic_attack.jpg', description: 'Mejora la pasiva Energetic Basic Attack: +50/100/150/200% de energía por Basic Attack y +1% de probabilidad de crítico con Basic Attack por punto.', maxRank: 4, tier: 1, requires: null },
    ...
    { id: 'opportunity', name: 'Opportunity', icon: '🗡️', iconImg: 'img/talents/rogue/opportunity.jpg', description: 'Aumenta el daño de Backstab, Garrote y Ambush un 6% por punto.', maxRank: 4, tier: 3, requires: null },
    ...
    { id: 'deathliness', name: 'Deathliness', icon: '🗡️', iconImg: 'img/talents/rogue/deathliness.jpg', description: 'Garrote y Ambush te devuelven entre un 20% y un 50% de su coste de energía (aleatorio).', maxRank: 1, tier: 3, requires: { id: 'opportunity', points: 4 } },
    ...
    { id: 'misologist', name: 'Misologist', icon: '🧪', iconImg: 'img/talents/rogue/misologist.jpg', description: 'Los venenos aplicados a ti mismo duran 1 turno más por punto y la efectividad de Veneno Mortal y Veneno Vampírico aumenta un 10% por punto.', maxRank: 3, tier: 3, requires: null },
  ...
  abilities: [
    ...
    { id: 'poison_mastery', name: 'Poison Mastery', icon: '☠️', iconImg: 'img/capstones/rogue/poison_mastery.jpg', school: 'Físico', type: 'utility', requiredLevel: 1, costPct: 0, costEnergy: 0, castType: 'instant', cooldown: 6, noGcd: true, description: 'Aprenderla te permite poner venenos al instante. Durante 3 turnos potencia tu veneno activo: Veneno Mortal x2, Veneno Vampírico x3 o Wound (tus ataques reducen un 25% el daño del enemigo). CD 6.', buff: null, capstoneGate: 'poison_mastery' },
