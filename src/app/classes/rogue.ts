...
export const ROGUE: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'garrote', name: 'Garrote', icon: '🩹', iconImg: 'img/abilities/rogue/garrote.jpg', school: 'Físico', type: 'damage', requiredLevel: 14, damageType: 'physical', baseDamage: 10, spellPowerRatio: 0, costPct: 0, costEnergy: 45, castType: 'instant', cooldown: 0, description: 'Requiere estar en sigilo. Estrangula al enemigo causando sangrado prolongado.', requiresStealth: true, generatesCombo: 1, noWeaponScaling: true, damageRanges: [{ rank: 1, level: 14, min: 100, max: 150 }, { rank: 2, level: 22, min: 160, max: 240 }, { rank: 3, level: 30, min: 280, max: 360 }], inflictsEffects: [{ type: 'dot', name: 'Garrote', value: 8, duration: 6, debuffType: 'disease' }], dotScales: true, dotRanges: [{ rank: 1, level: 14, value: 22, duration: 6 }, { rank: 2, level: 22, value: 36, duration: 6 }, { rank: 3, level: 30, value: 54, duration: 6 }] },
