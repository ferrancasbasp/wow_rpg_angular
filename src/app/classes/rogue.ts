...
export const ROGUE: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'improved_slice_and_dice', name: 'Improved Slice and Dice', icon: '⚔️', iconImg: 'img/abilities/rogue/slice_and_dice.jpg', description: 'Aumenta la duración de Slice and Dice en 3 turnos por punto.', maxRank: 2, tier: 2, requires: null },
  ...
  capstones: [
    ...
    { id: 'poison_mastery', name: 'Poison Mastery', icon: '☠️', iconImg: 'img/capstones/rogue/poison_mastery.jpg', description: 'Durante 3 turnos potencia tu veneno activo: Veneno Mortal x2, Veneno Vampírico x3 o Wound (tus ataques además reducen un 25% el daño del enemigo). CD 5.' },
  ],
  ...
  abilities: [
    ...
    { id: 'blade_flurry', name: 'Blade Flurry', icon: '🌪️', iconImg: 'img/capstones/rogue/bladefurry.jpg', school: 'Físico', type: 'utility', requiredLevel: 1, costPct: 0, costEnergy: 20, castType: 'instant', cooldown: 5, description: 'Frenesi de ataques durante 3 turnos. Tus ataques y habilidades de daño directo impactan tambien a otro enemigo cercano. Cuesta 20 de energia. CD 5.', buff: null, capstoneGate: 'blade_flurry' },
    { id: 'poison_mastery', name: 'Poison Mastery', icon: '☠️', iconImg: 'img/capstones/rogue/poison_mastery.jpg', school: 'Físico', type: 'utility', requiredLevel: 1, costPct: 0, costEnergy: 0, castType: 'instant', cooldown: 5, noGcd: true, description: 'Durante 3 turnos potencia tu veneno activo: Veneno Mortal x2, Veneno Vampírico x3 o Wound (tus ataques además reducen un 25% el daño del enemigo). CD 5.', buff: null, capstoneGate: 'poison_mastery' },
