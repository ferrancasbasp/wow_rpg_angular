...
export const DRUID: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'rejuvenation', name: 'Rejuvenation', icon: '🍃', iconImg: 'img/abilities/druid/rejuvenation.jpg', school: 'Naturaleza', type: 'heal', requiredLevel: 6, baseDamage: 26, spellPowerRatio: 0.8, costPct: 0.18, castType: 'instant', cooldown: 0, isHot: true, hotDuration: 4, description: 'Sana al objetivo durante 4 turnos. Aplicar manualmente en Efectos.', damageRanges: [{ rank: 1, level: 6, min: 51, max: 51 }, { rank: 2, level: 12, min: 94, max: 94 }, { rank: 3, level: 18, min: 153, max: 153 }] },
