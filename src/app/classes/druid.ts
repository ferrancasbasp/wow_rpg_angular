...
export const DRUID: CharacterClass = {
  ...
  capstones: [
    ...
    { id: 'nature_guardian', name: 'Nature Guardian', icon: '🌳', iconImg: 'img/capstones/druid/nature_guardian.jpg', description: 'El poder de la naturaleza te envuelve y te otorga 2 Moon Shards y 2 Sun Shards. Pasiva: Sunfall y Starsurge no cuestan maná. CD 8.' },
  ],
