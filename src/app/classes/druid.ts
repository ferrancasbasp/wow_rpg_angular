...
export const DRUID: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'rebirth', name: 'Rebirth', icon: '🌱', iconImg: 'img/abilities/druid/rebirth.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 20, costPct: 0.35, castType: 'cast', cooldown: 10, description: 'Devuelve a la vida a un aliado muerto en combate con un porcentaje de su vida máxima. Los rangos superiores reviven con más vida. CD 10.', buff: null, damageRanges: [{ rank: 1, level: 20, min: 25, max: 25 }, { rank: 2, level: 30, min: 35, max: 35 }, { rank: 3, level: 40, min: 45, max: 45 }, { rank: 4, level: 50, min: 55, max: 55 }, { rank: 5, level: 60, min: 65, max: 65 }] },
