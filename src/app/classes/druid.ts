...
export const DRUID: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'lunar_healing', name: 'Lunar Healing', icon: '🌙', iconImg: 'img/talents/druid/lunar_healing.jpg', description: 'Tus hechizos de curación tienen un 10% de probabilidad por punto de otorgarte una Moon Shard y reducen su coste de maná un 5% por punto.', maxRank: 3, tier: 1, requires: null },
    ...
    { id: 'first_of_the_wild', name: 'First of the Wild', icon: '👊', iconImg: 'img/abilities/druid/basic_attack.jpg', description: 'Tus Basic Attacks te curan un 1% de tu vida máxima y te restauran un 1% de tu maná máximo por punto.', maxRank: 3, tier: 2, requires: null },
    ...
    { id: 'improved_hurricane', name: 'Improved Hurricane', icon: '🌪️', iconImg: 'img/abilities/druid/hurricane.jpg', description: 'Aumenta el daño de Hurricane un 20% por punto y reduce su coste de maná un 10% por punto.', maxRank: 2, tier: 3, requires: null },
    ...
    { id: 'stone_of_rhythms', name: 'Stone of Rhythms', icon: '🔮', iconImg: 'img/talents/druid/clearcasting.jpg', description: 'Al final de tu turno tienes un 15% de probabilidad por punto de gastar una Sun Shard para recuperar un 10% de tu maná máximo.', maxRank: 3, tier: 3, requires: null },
  ...
  capstones: [
    ...
    { id: 'nature_guardian', name: 'Nature Guardian', icon: '🌳', iconImg: 'img/capstones/druid/nature_guardian.jpg', description: 'El poder de la naturaleza te envuelve y te otorga 2 Moon Shards y 2 Sun Shards. Pasiva: Sunfall y Starsurge no cuestan maná y son instantáneos. CD 8.' },
  ],
  ...
  abilities: [
    ...
    { id: 'sunfire', name: 'Sunfire', icon: '🔥', iconImg: 'img/abilities/druid/sunfire.jpg', school: 'Fuego', type: 'damage', requiredLevel: 12, damageType: 'magical', baseDamage: 15, spellPowerRatio: 0.4, costPct: 0.16, castType: 'instant', cooldown: 0, generatesSunShard: 1, isDot: true, dotDuration: 2, description: 'Quema al enemigo y le inflige el mismo daño que Moonfire pero en menos tiempo. El DoT solar más caro. Genera 1 Sun Shard.', damageRanges: [{ rank: 1, level: 12, min: 43, max: 53 }, { rank: 2, level: 18, min: 72, max: 87 }, { rank: 3, level: 24, min: 106, max: 126 }], inflictsEffects: [{ type: 'dot', name: 'Sunfire', value: 29, duration: 2, debuffType: 'magic' }], dotScales: true, dotRanges: [{ rank: 1, level: 12, value: 29, duration: 2 }, { rank: 2, level: 18, value: 39, duration: 2 }, { rank: 3, level: 24, value: 49, duration: 2 }] },
    { id: 'starsurge', name: 'Starsurge', icon: '🌟', iconImg: 'img/abilities/druid/starsurge.jpg', school: 'Arcano', type: 'damage', requiredLevel: 10, damageType: 'magical', baseDamage: 40, spellPowerRatio: 1.5, costPct: 0.12, castType: 'cast', cooldown: 0, spendsCombo: true, noWeaponScaling: true, description: 'Invoca el poder de las estrellas. Gasta todas las Moon Shards. Cada Moon Shard aumenta el daño.', damageRanges: [{ rank: 1, level: 10, min: 40, max: 52 }, { rank: 2, level: 18, min: 70, max: 90 }, { rank: 3, level: 26, min: 110, max: 140 }] },
    ...
    { id: 'healing_touch', name: 'Healing Touch', icon: '🌿', iconImg: 'img/abilities/druid/healing_touch.jpg', school: 'Naturaleza', type: 'heal', requiredLevel: 1, baseDamage: 80, spellPowerRatio: 1.2, costPct: 0.21, castType: 'cast', cooldown: 0, description: 'Sana una gran cantidad de salud al objetivo.', damageRanges: [{ rank: 1, level: 1, min: 48, max: 66 }, { rank: 2, level: 8, min: 108, max: 144 }, { rank: 3, level: 14, min: 216, max: 276 }] },
    { id: 'rejuvenation', name: 'Rejuvenation', icon: '🍃', iconImg: 'img/abilities/druid/rejuvenation.jpg', school: 'Naturaleza', type: 'heal', requiredLevel: 6, baseDamage: 26, spellPowerRatio: 0.8, costPct: 0.18, castType: 'instant', cooldown: 0, isHot: true, hotDuration: 4, description: 'Sana al objetivo durante 4 turnos.', damageRanges: [{ rank: 1, level: 6, min: 51, max: 51 }, { rank: 2, level: 12, min: 94, max: 94 }, { rank: 3, level: 18, min: 153, max: 153 }] },
    { id: 'moonkin_form', name: 'Moonkin Form', icon: '🪶', iconImg: 'img/abilities/druid/moonkin_form.jpg', school: 'Físico', type: 'utility', requiredLevel: 10, costPct: 0.15, castType: 'instant', cooldown: 1,       description: 'Te transformas en Lechúcico durante 8 turnos. +10 armadura y +6% probabilidad de critico magico.', buff: { stat: 'moonkin', duration: 8, applySelf: true }, buffRanks: [{ rank: 1, level: 10, value: 1, costPct: 0.15 }] },
    { id: 'mark_of_the_wild', name: 'Mark of the Wild', icon: '🐾', iconImg: 'img/abilities/druid/mark_of_the_wild.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 2, costPct: 0.08, castType: 'instant', cooldown: 0, description: 'Aumenta todos los atributos. El buffo más mítico del druida.', buff: { stat: 'all_stats', duration: 30, applySelf: false }, buffRanks: [{ rank: 1, level: 2, value: 2, costPct: 0.08 }, { rank: 2, level: 12, value: 4, costPct: 0.09 }, { rank: 3, level: 24, value: 7, costPct: 0.10 }, { rank: 4, level: 36, value: 10, costPct: 0.11 }] },
    { id: 'rebirth', name: 'Rebirth', icon: '🌱', iconImg: 'img/abilities/druid/rebirth.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 20, costPct: 0.35, castType: 'cast', cooldown: 10, description: 'Devuelve a la vida a un aliado muerto en combate con una cantidad fija de vida. Los rangos superiores reviven con más vida (200/400/600/800/1000). CD 10.', buff: null, damageRanges: [{ rank: 1, level: 20, min: 200, max: 200 }, { rank: 2, level: 30, min: 400, max: 400 }, { rank: 3, level: 40, min: 600, max: 600 }, { rank: 4, level: 50, min: 800, max: 800 }, { rank: 5, level: 60, min: 1000, max: 1000 }] },
    ...
    { id: 'nature_guardian', name: 'Nature Guardian', icon: '🌳', iconImg: 'img/capstones/druid/nature_guardian.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 1, costPct: 0, castType: 'instant', cooldown: 8, noGcd: true, description: 'Te otorga 2 Moon Shards y 2 Sun Shards. Pasiva: Sunfall y Starsurge no cuestan maná y son instantáneos. CD 8.', buff: null, capstoneGate: 'nature_guardian' },
  ],
};
