...
export const DRUID: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'healing_touch', name: 'Healing Touch', icon: '🌿', iconImg: 'img/abilities/druid/healing_touch.jpg', school: 'Naturaleza', type: 'heal', requiredLevel: 1, baseDamage: 80, spellPowerRatio: 1.2, costPct: 0.16, castType: 'cast', cooldown: 0, description: 'Sana una gran cantidad de salud al objetivo.', damageRanges: [{ rank: 1, level: 1, min: 40, max: 55 }, { rank: 2, level: 8, min: 90, max: 120 }, { rank: 3, level: 14, min: 180, max: 230 }] },
    { id: 'rejuvenation', name: 'Rejuvenation', icon: '🍃', iconImg: 'img/abilities/druid/rejuvenation.jpg', school: 'Naturaleza', type: 'heal', requiredLevel: 6, baseDamage: 26, spellPowerRatio: 0.8, costPct: 0.14, castType: 'instant', cooldown: 0, isHot: true, hotDuration: 4, description: 'Sana al objetivo durante 4 turnos. Aplicar manualmente en Efectos.', damageRanges: [{ rank: 1, level: 6, min: 51, max: 51 }, { rank: 2, level: 12, min: 94, max: 94 }, { rank: 3, level: 18, min: 153, max: 153 }] },
