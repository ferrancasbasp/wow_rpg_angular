...
export const DRUID: CharacterClass = {
  ...
  capstones: [
    { id: 'gift_of_the_wild', name: 'Gift of the Wild', icon: '🎁', iconImg: 'img/capstones/druid/gift_of_the_wild.jpg', description: 'Pasiva. Aumenta todas tus estadísticas en una cantidad igual a tu nivel. A nivel 25, +25 a todas las estadísticas.' },
    { id: 'insect_swarm', name: 'Insect Swarm', icon: '🦗', iconImg: 'img/capstones/druid/insect_swarm.jpg', description: 'Invoca un enjambre de insectos que reduce enormemente el ataque del enemigo un 50% durante 2 turnos. CD 2.' },
    { id: 'nature_guardian', name: 'Nature Guardian', icon: '🌳', iconImg: 'img/capstones/druid/nature_guardian.jpg', description: 'El poder de la naturaleza te envuelve: llena tu barra de Fases Lunares al máximo y lanza un Starsurge como si tuvieses todas las fases. CD 10.' },
  ],
  ...
  abilities: [
    ...
    { id: 'moonkin_form', name: 'Moonkin Form', icon: '🪶', iconImg: 'img/abilities/druid/moonkin_form.jpg', school: 'Físico', type: 'utility', requiredLevel: 10, costPct: 0.15, castType: 'instant', cooldown: 1,       description: 'Te transformas en Lechúcico. +10 armadura y +5% probabilidad de critico magico.', buff: { stat: 'moonkin', duration: 30, applySelf: true }, buffRanks: [{ rank: 1, level: 10, value: 1, costPct: 0.15 }] },
    { id: 'mark_of_the_wild', name: 'Mark of the Wild', icon: '🐾', iconImg: 'img/abilities/druid/mark_of_the_wild.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 2, costPct: 0.08, castType: 'instant', cooldown: 0, description: 'Aumenta todos los atributos (máx. +7 en aliados). El buffo más mítico del druida. Aplicar manualmente en Efectos.', buff: { stat: 'all_stats', duration: 30, applySelf: false }, buffRanks: [{ rank: 1, level: 2, value: 2, costPct: 0.08 }, { rank: 2, level: 12, value: 4, costPct: 0.09 }, { rank: 3, level: 24, value: 7, costPct: 0.10 }, { rank: 4, level: 36, value: 7, costPct: 0.11 }] },
    ...
    { id: 'insect_swarm', name: 'Insect Swarm', icon: '🦗', iconImg: 'img/capstones/druid/insect_swarm.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 1, costPct: 0.05, castType: 'instant', cooldown: 2, description: 'Enjambre de insectos: baja un 50% el ataque del enemigo durante 2 turnos. CD 2.', buff: null, capstoneGate: 'insect_swarm', inflictsEffects: [{ type: 'debuff', name: 'Insect Swarm', target: 'attackPower', value: 50, duration: 2, debuffType: 'magic' }] },
    { id: 'nature_guardian', name: 'Nature Guardian', icon: '🌳', iconImg: 'img/capstones/druid/nature_guardian.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 1, costPct: 0, castType: 'instant', cooldown: 10, noGcd: true, description: 'Llena tus Fases Lunares y lanza un Starsurge a máxima potencia. CD 10.', buff: null, capstoneGate: 'nature_guardian' },
  ],
};
