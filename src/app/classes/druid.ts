...
export const DRUID: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'dispel', name: 'Dispel', icon: '✨', iconImg: 'img/abilities/druid/dispel.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 8, costPct: 0.05, castType: 'instant', cooldown: 0, description: 'Elimina una maldición (curse) del objetivo.', bonusPerRank: [0, 0, 0] },
  ],
};
