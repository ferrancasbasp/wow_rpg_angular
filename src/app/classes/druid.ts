...
export const DRUID: CharacterClass = {
  ...
  abilities: [
    ...
    { id: 'moonfire', name: 'Moonfire', icon: '🌙', iconImg: 'img/abilities/druid/moonfire.jpg', school: 'Arcano', type: 'damage', requiredLevel: 4, damageType: 'magical', baseDamage: 20, spellPowerRatio: 0.4, costPct: 0.11, castType: 'instant', cooldown: 0, generatesCombo: 1, isDot: true, dotDuration: 3, description: 'Quema al enemigo y le inflige daño durante 3 turnos. Los DoTs cuestan más maná que los casts. Genera 1 Moon Shard.', damageRanges: [{ rank: 1, level: 4, min: 18, max: 22 }, { rank: 2, level: 10, min: 30, max: 40 }, { rank: 3, level: 16, min: 55, max: 65 }], inflictsEffects: [{ type: 'dot', name: 'Moonfire', value: 10, duration: 3, debuffType: 'magic' }], dotScales: true, dotRanges: [{ rank: 1, level: 4, value: 10, duration: 3 }, { rank: 2, level: 10, value: 18, duration: 3 }, { rank: 3, level: 16, value: 25, duration: 3 }] },
    ...
    { id: 'hurricane', name: 'Hurricane', icon: '🌪️', iconImg: 'img/abilities/druid/hurricane.jpg', school: 'Naturaleza', type: 'damage', requiredLevel: 20, damageType: 'magical', aoe: true, baseDamage: 45, spellPowerRatio: 0.6, costPct: 0.13, castType: 'instant', cooldown: 3, noWeaponScaling: true, description: 'Crea una tormenta en área que daña a todos los enemigos. No gasta Moon ni Sun Shards.', damageRanges: [{ rank: 1, level: 20, min: 60, max: 80 }, { rank: 2, level: 28, min: 110, max: 130 }] },
