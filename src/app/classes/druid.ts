...
export const DRUID: CharacterClass = {
  ...
  talents: [
    ...
    { id: 'first_of_the_wild', name: 'First of the Wild', icon: '👊', iconImg: 'img/abilities/druid/basic_attack.jpg', description: 'Tus Basic Attacks te curan un 2% de tu vida máxima y te restauran un 2% de tu maná máximo por punto.', maxRank: 3, tier: 2, requires: null },
  ...
  abilities: [
    ...
    { id: 'entangling_roots', name: 'Entangling Roots', icon: '🌱', iconImg: 'img/abilities/druid/entangling_roots.jpg', school: 'Naturaleza', type: 'utility', requiredLevel: 8, costPct: 0.06, castType: 'cast', cooldown: 4, description: 'Inmoviliza al objetivo durante 2 turnos.', buff: { stat: 'rooted', duration: 2, applySelf: false }, buffRanks: [{ rank: 1, level: 8, value: 0, costPct: 0.06 }, { rank: 2, level: 16, value: 0, costPct: 0.06 }, { rank: 3, level: 24, value: 0, costPct: 0.06 }] },
